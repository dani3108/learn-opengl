...
// Vertex data of 2 triangles
// Triangle A
constexpr GLfloat vertices_A[]{
    -0.8f, -0.5f, 0.0f,
    -0.4f, +0.5f, 0.0f,
    +0.0f, -0.5f, 0.0f
};
// Triangle B
constexpr GLfloat vertices_B[]{
    +0.0f, -0.5f, 0.0f,
    +0.4f, +0.5f, 0.0f,  
    +0.8f, -0.5f, 0.0f   
};  
...
const GLchar* fragmentShaderOrangeSource{
    "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
const GLchar* fragmentShaderYellowSource{
    "#version 330 core\n"
    "out vec4 FragColor;\n"
    "void main()\n"
    "{\n"
...
int main()
{
    ...
    // 2 triangles with different color = 2 shaders and 2 programs
    ...
    // Since we are rebinding another VAO, we dont need to unbind
    // glBindVertexArray(0);

    // Do it again for the second triangle
